...
def generate(root: Path) -> dict[str, str]:
    ...
    lines = ["# 结果总览", "", "<!-- Generated by scripts/repository.py; edit the sources, then build. -->", "",
             "当前候选 A 已完成 AP1，见[研究报告](../docs/reports/audit/SHARED_MISSING_EVENTS_AP1_REPORT.md)与[锁定论文主张](../docs/research/SHARED_MISSING_EVENTS_AP1_CLAIMS_LOCK.md)；[AP0 报告](../docs/reports/audit/SHARED_MISSING_EVENTS_AP0_REPORT.md)保留首轮证据。下列开发集核心表属于原 UrbanEV 预测研究，两个评价对象分别报告。", "",
