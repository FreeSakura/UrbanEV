...
\path{experiments/09_distill_v2/PARIS_TEACHER_RESULT_REVIEW.md} & Independent result-to-claim check and provenance warnings & Warnings limit stronger process claims; they do not reverse the gate \\
