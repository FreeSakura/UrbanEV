\begin{table*}[htbp]
\centering
\caption{Author and reviewer checklist derived from this study.}
...
10 & Engineering measurement & device, software, precision, batch/request shape, synchronization, warm-up, repetitions, P50/P95, throughput & Is a hardware-specific measurement being presented as general efficiency? \\
...
12 & Claim source & claim ID, authoritative artifact, SHA-256, evaluation type, allowed/prohibited wording, scope limit & Can every headline number be traced, and are diagnostics/subchecks kept at their original evidence type? \\
